...
public function __construct()
    ...
    */
	...
	public function get_datos_usuario($fun_id){
        $sql = 'select tmp.fun_id,tmp.uni_id,tmp.car_id,tmp.fun_nombre,tmp.fun_ci,tmp.fun_domicilio,tmp.fun_telefono,tmp.fun_estado,
		...
		GROUP BY tmp.fun_id,tmp.uni_id,tmp.car_id,tmp.fun_nombre,tmp.fun_ci,tmp.fun_domicilio,tmp.fun_telefono,tmp.fun_estado,
		tmp.fun_usuario,tmp.fun_password,tmp.fun_estado,tmp.fun_paterno,tmp.fun_materno,tmp.fun_cargo,tmp.fecha_creacion,
