...
/*=================================== LISTA DE PRODUCTOS ANUAL ====================================*/
    ...
    function add_prod_ejec_gest($id_prod,$gestion,$m_id,$ejecutado,$mverificacion,$observacion){
        $data = array(
            'prod_id' => $id_prod,
            'm_id' => $m_id,
            'pejec_fis' => $ejecutado,
    ...
    function add_no_ejec_prod($prod_id,$mes_id,$mverificacion,$observacion){
        $data = array(
            'prod_id' => $prod_id,
            'm_id' => $mes_id,
            'g_id' => $this->gestion,
