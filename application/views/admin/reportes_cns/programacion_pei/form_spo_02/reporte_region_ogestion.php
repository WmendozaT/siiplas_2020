    ...
    <page_header>
                        ...
                        <tr style="width: 100%; border: solid 0px black; text-align: center; font-size: 8pt; font-style: oblique;">
                          ...
                          <td width=60%; align=center>
                            <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                              ...
                              <tr>
                                <td style="width:100%; height: 1.2%; font-size: 13pt;" align="center"><b>OPERACIONES </b></td>
                              </tr>
                            </table>
                          </td>
                          <td width=19%; align=left style="font-size: 8px;">
                            &nbsp; <b style="font-size: 9pt;">FORMULARIO POA N° 2</b>
                          </td>
                        </tr>
                  </table>
        ...
        <?php
            if($regional[0]['dep_id']!=10){
                echo 'REGIONAL : '.strtoupper($regional[0]['dep_departamento']).'';
            }
            else{
                echo ''.strtoupper($regional[0]['dep_departamento']).'';
            }
        ?>
        </b></div>
    </page_header>
