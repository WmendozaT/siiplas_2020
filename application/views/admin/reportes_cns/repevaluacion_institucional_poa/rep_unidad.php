                        ...
                        <article class="col-sm-12">
                            ...
                            <div class="jarviswidget" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
                                <header>
                                    ...
                                    <h2 title="<?php echo "aper_id : ".$proyecto[0]['aper_id']." -- proy id : ".$proyecto[0]['proy_id'];?>">EVALUACI&Oacute;N POR UNIDAD / PROYECTO</h2>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                      <hr>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                                <h2 class="alert alert-success" align="center">DETALLE DE EVALUACI&Oacute;N POR SERVICIOS</b></h2>
