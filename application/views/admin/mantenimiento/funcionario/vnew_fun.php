    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Mantenimiento</li><li>Funcionarios</li><li>Nuevo Registro</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        <form action="<?php echo site_url("admin").'/funcionario/add_fun' ?>" method="post" id="resp_form" name="resp_form" class="smart-form">
                                                ...
                                                <div class="well">
                                                    <div class="row">
                                                        <section class="col col-4">
                                                            ...
                                                            <input class="form-control" type="text" name="ci" id="ci" onblur="javascript:fun_ci();" onkeypress="if (this.value.length < 10) { return soloNumeros(event);}else{return false; }"  onpaste="return false">
                                                        </section>
                                                        <section class="col col-4">
                                                ...
                                                <div class="well">
                                                    <div class="row">
                                                        ...
                                                        <section class="col col-3">
                                                            ...
                                                            <input class="form-control" type="text" name="usuario" id="usuario" onblur="javascript:fun_ci();" placeholder="Usuario" style="width:100%;" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="15">
                                                        </section>
                                                        <section class="col col-3">
                                                            <label class="label"><font color="blue">PASSWORD</font></label>
                                                            <input class="form-control" type="Password" name="password" id="password" placeholder="Password" maxlength="15">
                                                        </section>
                                                    </div>    
                                                </div><br>
                                                            ...
                                                            <label class="label">SELECCIONE ROL : <b id="titulo"></b></label>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col col-10">
                                                                        ...
                                                                        <input type="text" name="tot" id="tot" value="0">
                                                                    </div>
                                                                </div>
                                                        </section>
                                                    </div>
                                            ...
                                            <footer>
                                                <input type="button" value="GUARDAR" id="btsubmit" class="btn btn-primary" onclick="valida_envia()" title="GUARDAR RESPONSABLE">
                        ...
                        $.ajax({
                            ...
                            success:function(datos){
                                ...
                                if(datos.trim() =='false'){
                                    ...
                                    var url = "<?php echo site_url("admin")?>/funcionario/verif_usuario";
                                                $.ajax({
                                                    type:"post",
                                                    url:url,
                                                    data:{user:usuario},
