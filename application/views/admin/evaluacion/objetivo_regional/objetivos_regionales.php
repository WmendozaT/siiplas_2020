					...
					<div class="row">
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	                        <section id="widget-grid" class="well">
	                            <div class="">
	                            	<h1>EVALUACI&Oacute;N OBJETIVOS REGIONALES - <?php echo strtoupper($departamento[0]['dep_departamento']);?></h1>
	                              <h1></h1>
	                            </div>
	                        </section>
	                    </article>
	                   ...
	                   <article class="col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
								<header>
									...
									<h2><b>EVALUACI&Oacute;N <?php echo $trimestre[0]['trm_descripcion'];?></b></h2>
								</header>
								<!-- widget div-->
								<div>
									<?php echo $tabla;?>
            ...
            $(".mod_ff").on("click", function (e) {
                ...
                request.done(function (response, textStatus, jqXHR) { 
                    if (response.respuesta == 'correcto') {
                    	...
                    	document.getElementById("mtrm_id").value = response.trimestre[0]['trm_id'];
