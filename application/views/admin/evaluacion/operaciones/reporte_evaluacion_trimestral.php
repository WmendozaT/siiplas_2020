...
<page backtop="41mm" backbottom="35.5mm" backleft="5mm" backright="5mm" pagegroup="new">
    <page_header>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;">
                        <tr style="width: 100%; border: solid 0px black; text-align: center; font-size: 8pt; font-style: oblique;">
                          ...
                          <td width=15%; align=center >
                            &nbsp; <b style="font-size: 6.5pt;"><?php echo $tmes[0]['trm_descripcion']; ?></b>
                          </td>
                        </tr>
                  </table>
                </td>
        ...
        <div align="center">EVALUACI&Oacute;N POA - <?php echo $this->session->userdata('gestion')?> 
        <!-- <?php
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:96%;" align="center">
            <tr>
                <td style="width: 33%;">
                    <table border="1" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                        <tr>
                            <td style="width:100%;height:12px;"><b>JEFATURA DE UNIDAD O AREA / RESP. DE AREA REGIONALES</b></td>
                        </tr>
                        <tr>
                ...
                <td style="width: 33%;">
                    <table border="1" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                        <tr>
                          <td style="width:100%;height:12px;"><b>JEFATURA DE DEPARTAMENTOS / SERV. GENERALES REGIONAL / JEFATURA MEDICA REG.</b></td>
                        </tr>
                        <tr>
                          <td align=center><br><br><br><br><br><b>FIRMA</b></td>
                        </tr>
                ...
                <td style="width: 33%;">
                    <table border="1" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                        <tr>
                          <td style="width:100%;height:12px;"><b>ADMINISTRADOR REGIONAL / GERENCIAS DE AREA / GERENCIA GENERAL</b></td>
                        </tr>
                        <tr>
                          <td align=center><br><br><br><br><br><b>FIRMA</b></td>
                        </tr>
            ...
            <tr>
                ...
                <td style="width: 33%; text-align: right">
                    <!-- <?php echo "OCT. / " . date("Y").', '.$this->session->userdata('funcionario'); ?> - pag. [[page_cu]]/[[page_nb]] -->
...
try{
    ...
    $html2pdf->Output('EVALUACIÓN POA '.$proyecto[0]['proy_nombre'].'-'.$proyecto[0]['dep_sigla'].' '.$componente[0]['com_componente'].'.pdf');
}
