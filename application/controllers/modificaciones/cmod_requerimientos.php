...
class Cmod_requerimientos extends CI_Controller {  
    ...
    /*----- Servicios de Unidad  ------*/
/*    public function procesos($proy_id){
      ...
      //   $titulo='
      //   <h1> '.$data['proyecto'][0]['tipo_adm'].' : <small>'.$data['proyecto'][0]['aper_programa'].''.$data['proyecto'][0]['aper_proyecto'].''.$data['proyecto'][0]['aper_actividad'].' - '.$data['proyecto'][0]['tipo'].' '.$data['proyecto'][0]['act_descripcion'].' '.$data['proyecto'][0]['abrev'].'</small>';        
      //   $data['tabla']=$this->mis_procesos($proy_id);
      //   $this->load->view('admin/modificacion/operaciones/requerimientos/procesos', $data);
      // }
      // else{
      //   redirect('mod/cite_servicios/'.$proy_id);
      // }
      redirect('mod/cite_servicios/'.$proy_id);
    }*/

    /*------------------- LISTA DE REQUERIMIENTOS -------------------*/
    public function requerimientos2($cite_id,$proy_id,$tp_ins){
    ...
    /*----- REQUERIMIENTOS ------*/
    public function requerimientos($cite_id,$tp_ins){
      $data['menu']=$this->menu(3); //// genera menu
      $data['cite'] = $this->model_modificacion->get_cite_insumo($cite_id);
      
      if(count($data['cite'])!=0){
        $data['proyecto'] = $this->model_proyecto->get_id_proyecto($data['cite'][0]['proy_id']); /// Proyecto de Inversion
        
        if(count($data['proyecto'])!=0){
          $fase = $this->model_faseetapa->get_id_fase($data['cite'][0]['proy_id']); /// Fase Activa
          if($data['proyecto'][0]['tp_id']==4){ /// Gasto Corriente
            ...
            $data['titulo']=$this->titulo_cabecera($data['proyecto'],$tp_ins); /// CABECERA

            $data['tp_ins']=$tp_ins;
            $data['monto']=$this->ppto($data['proyecto']);
            $data['tabla']=$this->lista_requerimientos($cite_id,$data['cite'][0]['proy_id'],$tp_ins); /// LISTA DE REQUERIMIENTO
            $data['part_padres'] = $this->model_modificacion->list_part_padres_asig($data['proyecto'][0]['aper_id']);//partidas padres
            $data['part_hijos'] = $this->model_modificacion->list_part_hijos_asig($data['proyecto'][0]['aper_id']);//partidas hijos

            $this->load->view('admin/modificacion/operaciones/requerimientos/list_requerimientos', $data);
        }
        else{
    ...
    /*------ TITULO CABECERA -----*/
    public function titulo_cabecera($proyecto,$tp_ins){
      $tabla='';
      if($this->gestion!=2020){ /// 2018-2019
        if($proyecto[0]['tp_id']==1){ /// Proyecto de Inversion
          $act=$this->model_actividad->get_actividad_gestion($tp_ins,$this->gestion);
          $prod = $this->model_producto->get_producto_id($act[0]['prod_id']); ///// DATOS DEL PRODUCTO
          $tabla.=' <h1> <b>APERTURA PROGRAM&Aacute;TICA : </b><small>'.$proyecto[0]['aper_programa'].''.$proyecto[0]['aper_proyecto'].''.$proyecto[0]['aper_actividad'].' - '.$proyecto[0]['proy_nombre'].'</small>
                    <h1> <b>OPERACI&Oacute;N : </b><small>'.$prod[0]['prod_producto'].'</small></h1>
                    <h1> <b>ACTIVIDAD : </b><small>'.$act[0]['act_actividad'].'</small></h1>';
        }
        else{ /// Gasto Corriente
          $data['proyecto'] = $this->model_proyecto->get_datos_proyecto_unidad($proyecto[0]['proy_id']);
          $prod = $this->model_producto->get_producto_id($tp_ins); ///// DATOS DEL PRODUCTO
          $tabla.=' <h1><b> APERTURA PROGRAM&Aacute;TICA : </b><small>'.$proyecto[0]['aper_programa'].''.$proyecto[0]['aper_proyecto'].''.$proyecto[0]['aper_actividad'].' - '.$proyecto[0]['proy_nombre'].'</small>
                    <h1><b> OPERACI&Oacute;N : </b><small>'.$prod[0]['prod_producto'].'</small></h1>';
        }
      }
        ...
        if($proyecto[0]['tp_id']==1){  /// Proyectos de Inversion
          $act=$this->model_actividad->get_actividad_gestion($tp_ins,$this->gestion);
          $prod = $this->model_producto->get_producto_id($act[0]['prod_id']); ///// DATOS DEL PRODUCTO
          $com = $this->model_componente->get_componente($prod[0]['com_id']); /// DATOS COMPONENTE
          $tabla.=' <h1><b> APERTURA PROGRAM&Aacute;TICA : <b><small>'.$proyecto[0]['aper_programa'].''.$proyecto[0]['aper_proyecto'].''.$proyecto[0]['aper_actividad'].' - '.$proyecto[0]['proy_nombre'].'</small>
                    <h1><b> ACTIVIDAD : <b><small>'.$prod[0]['prod_cod'].'.- '.$prod[0]['prod_producto'].'</small></h1>
                    <h1><b> TAREA : <b><small>'.$act[0]['act_actividad'].'</small></h1>';
        }
        else{
          $prod = $this->model_producto->get_producto_id($tp_ins); ///// DATOS DEL PRODUCTO
          $com = $this->model_componente->get_componente($prod[0]['com_id']); /// DATOS SERVICIO
          $tabla.=' <h1><b> '.$proyecto[0]['tipo_adm'].' : <b><small>'.$proyecto[0]['aper_programa'].''.$proyecto[0]['aper_proyecto'].''.$proyecto[0]['aper_actividad'].' - '.$proyecto[0]['tipo'].' '.$proyecto[0]['act_descripcion'].' '.$proyecto[0]['abrev'].'</small></h1>
                    <h1><b> ACTIVIDAD : <b><small>'.$prod[0]['prod_cod'].'.- '.$prod[0]['prod_producto'].'</small></h1>
                    <h1><b> SERVICIO : <b><small>'.$com[0]['com_componente'].'</small></h1>';
        }
      }
    ...
    public function requerimientoss($cite_id,$tp_ins){
      $data['menu']=$this->menu(3); //// genera menu
      $data['proyecto'] = $this->model_proyecto->get_id_proyecto($proy_id);
      ...
      if($data['proyecto'][0]['proy_act']==1){
          $act=$this->model_actividad->get_actividad_gestion($tp_ins,$this->gestion);
          $prod = $this->model_producto->get_producto_id($act[0]['prod_id']); ///// DATOS DEL PRODUCTO
          $data['titulo']='<h1> OPERACI&Oacute;N : <small>'.$prod[0]['prod_producto'].'</small></h1>
                            <h1> ACTIVIDAD : <small>'.$act[0]['act_actividad'].'</small></h1>';
        }
        elseif($data['proyecto'][0]['proy_act']==0){
          $prod = $this->model_producto->get_producto_id($tp_ins); ///// DATOS DEL PRODUCTO
          $data['titulo']='<h1> OPERACI&Oacute;N : <small>'.$prod[0]['prod_producto'].'</small></h1>';
        }

        $data['fuente']=$this->model_faseetapa->presupuesto_asignados($data['proyecto'][0]['proy_id'],$this->gestion);
        $data['aper']=$this->model_proyecto->get_programa_padre($data['proyecto'][0]['aper_programa']);
      ...
      $data['tp_ins']=$tp_ins;
      /*if($tp_ins==29865){
        $this->recupera_insumos_eliminados($cite_id,$proy_id,$tp_ins);
      }*/
      $data['tabla']=$this->lista_requerimientos($cite_id,$proy_id,$tp_ins);

      $this->load->view('admin/modificacion/operaciones/requerimientos/list_requerimientos', $data);
    }

    /*--- Recupera Insumos Requerimientos eliminados ---*/ 
    public function recupera_insumos_eliminados($cite_id,$proy_id,$tp_ins){
      $cite = $this->model_modificacion->get_cite_insumo($cite_id);
      $proyecto = $this->model_proyecto->get_id_proyecto($cite[0]['proy_id']);
      $fase = $this->model_faseetapa->get_id_fase($cite[0]['proy_id']);

      $requerimientos_del = $this->model_modificacion->requerimientos_programado_eliminados($cite_id,$cite[0]['proy_id'],$fase[0]['pfec_ejecucion'],$proyecto[0]['proy_act']);
      ...
      $update_insumo_del = array(
        'estado' => 3,
      );
      $this->db->where('insc_id', $cite_id);
      $this->db->update('_insumo_delete', $update_insumo_del);
    }

    /*------------- REPORTE CITE REQUERIMIENTOS -------------*/
    public function reporte_modificacion($cite_id,$tp_ins){
      $data['cite']=$this->model_modificacion->get_cite_insumo($cite_id);
      if(count($data['cite'])!=0){
        ...
        if($data['proyecto'][0]['tp_id']==1){
          $act=$this->model_actividad->get_actividad_gestion($tp_ins,$this->gestion);
          $prod = $this->model_producto->get_producto_id($act[0]['prod_id']); ///// DATOS DEL PRODUCTO
          $data['componente'] = $this->model_componente->get_componente_pi($prod[0]['com_id']);
          $data['titulo']='<tr style="font-size: 8pt;">
                              <td style="height: 1.2%"><b>PROYECTO</b></td>
                              <td style="width:90%;">: '.$data['proyecto'][0]['aper_programa'].''.$data['proyecto'][0]['aper_proyecto'].''.$data['proyecto'][0]['aper_actividad'].' - '.$data['proyecto'][0]['proy_nombre'].'</td>
                           </tr>
                           <tr style="font-size: 8pt;">
                              <td style="height: 1.2%"><b>COMPONENTE</b></td>
                              <td style="width:90%;">: '.$data['componente'][0]['com_componente'].'</td>
                           </tr>
                           <tr style="font-size: 8pt;">
                              <td style="height: 1.2%"><b>ACTIVIDAD</b></td>
                              <td style="width:90%;">: '.$prod[0]['prod_producto'].'</td>
                           </tr>
                           <tr style="font-size: 8pt;">
                              <td style="height: 1.2%"><b>TAREA</b></td>
                              <td style="width:90%;">: '.$act[0]['act_actividad'].'</td>
                           </tr>';
        }
        else{
          $data['proyecto'] = $this->model_proyecto->get_datos_proyecto_unidad($data['cite'][0]['proy_id']);
          ...
          $data['titulo']='
                          ...
                          <tr style="font-size: 8pt;">
                           ...
                           <tr style="font-size: 8pt;">
                              <td style="height: 1.2%"><b>ACTIVIDAD</b></td>
                              <td style="width:90%;">: '.$prod[0]['prod_cod'].'.- '.$prod[0]['prod_producto'].'</td>
                           </tr>';
        }

        $data['mes'] = $this->mes_nombre();
        $data['requerimientos']=$this->rep_requerimiento($cite_id);
        $this->load->view('admin/modificacion/operaciones/requerimientos/reporte_modificacion_requerimientos', $data);
      }
      else{
        echo "ERROR";
      }
...
/*    public function reporte_modificacion2019($cite_id,$tp_ins){
      $data['cite']=$this->model_modificacion->get_cite_insumo($cite_id);
      if(count($data['cite'])!=0){
        $data['proyecto']=$this->model_proyecto->get_id_proyecto($data['cite'][0]['proy_id']);
        ...
        if($data['proyecto'][0]['proy_act']==1){
          ...
          $prod = $this->model_producto->get_producto_id($act[0]['prod_id']); ///// DATOS DEL PRODUCTO
          $data['componente'] = $this->model_componente->get_componente_pi($prod[0]['com_id']);
          $data['titulo']='<tr style="font-size: 9px;">
                              <td style="height: 1.2%"><b>COMPONENTE</b></td>
                              <td style="width:90%;">: '.$data['componente'][0]['com_componente'].'</td>
                           </tr>
                           <tr style="font-size: 9px;">
                              <td style="height: 1.2%"><b>OPERACI&Oacute;N</b></td>
                              <td style="width:90%;">: '.$prod[0]['prod_producto'].'</td>
                           </tr>
                           <tr style="font-size: 9px;">
                              <td style="height: 1.2%"><b>ACTIVIDAD</b></td>
        ...
        elseif($data['proyecto'][0]['proy_act']==0){
          ...
          $data['componente'] = $this->model_componente->get_componente_pi($prod[0]['com_id']);
          $data['titulo']='<tr style="font-size: 9px;">
                              <td style="height: 1.2%"><b>SUB-ACTIVIDAD</b></td>
                              <td style="width:90%;">: '.$data['componente'][0]['com_componente'].'</td>
                           </tr>
                           <tr style="font-size: 9px;">
                              <td style="height: 1.2%"><b>OPERACI&Oacute;N</b></td>
        ...
        $data['mes'] = $this->mes_nombre();
        $data['requerimientos']=$this->rep_requerimiento($cite_id);
        $this->load->view('admin/modificacion/operaciones/requerimientos/reporte_modificacion_requerimientos_2019', $data);
      }
      else{
        echo "ERROR";
      }
    ...
    public function rep_requerimiento($cite_id){
      ...
      $proyecto = $this->model_proyecto->get_id_proyecto($cite[0]['proy_id']);
      $fase = $this->model_faseetapa->get_id_fase($cite[0]['proy_id']);
      $requerimientos_add = $this->model_modificacion->requerimientos_programado_agregados($cite_id,$cite[0]['proy_id'],$fase[0]['pfec_ejecucion'],$proyecto[0]['proy_act']);
      $tabla ='';
      if(count($requerimientos_add)!=0){
        ...
        $tabla.='<tr class="modo1" align="center">';
          $tabla.='<th style="width:1%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Nro.</th>';
          $tabla.='<th style="width:4%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Partida</th>';
          $tabla.='<th style="width:15%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Detalle Requerimiento</th>';
          $tabla.='<th style="width:7%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Unidad Medida</th>';
          $tabla.='<th style="width:5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Cantidad</th>';
          $tabla.='<th style="width:7%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Unitario</th>';
          $tabla.='<th style="width:7%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Costo Total</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Ene.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Feb.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Mar.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Abr.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">May.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Jun.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Jul.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Ago.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Sept.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Oct.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Nov.</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Dic.</th>';
          $tabla.='<th style="width:10%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Observaciones</th>';
        $tabla.='</tr>';
        $tabla.='</thead>';
        $tabla.='<tbody>';
        $nro=0;
        foreach ($requerimientos_add as $row){
          ...
          $tabla.='<tr class="modo1">';
            ...
            $tabla.='<td style="width: 3%; text-align: left;">'.$row['par_codigo'].'</td>';
            $tabla.='<td style="width: 10%; text-align: left;">'.$row['ins_detalle'].'</td>';
            $tabla.='<td style="width: 6%; text-align: left;">'.$row['ins_unidad_medida'].'</td>';
            $tabla.='<td style="width: 5%; text-align: left;">'.$row['ins_cant_requerida'].'</td>';
            $tabla.='<td style="width: 6%; text-align: right;">'.number_format($row['ins_costo_unitario'], 2, ',', '.').'</td>';
      ...
      $requerimientos_mod = $this->model_modificacion->requerimientos_programado_modificados($cite_id,$cite[0]['proy_id'],$fase[0]['pfec_ejecucion'],$proyecto[0]['proy_act']);
      if(count($requerimientos_mod)!=0){
        ...
        $tabla.='<tr class="modo1">';
          $tabla.='<th style="width:1%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Nro.</th>';
          $tabla.='<th style="width:3%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Partida</th>';
          $tabla.='<th style="width:10%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Detalle Requerimiento</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Unidad Medida</th>';
          $tabla.='<th style="width:5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Cantidad</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Unitario</th>';
          $tabla.='<th style="width:6%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Costo Total</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Ene.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Feb.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Mar.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Abr.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">May.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Jun.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Jul.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Ago.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Sept.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Oct.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Nov.</th>';
          $tabla.='<th style="width:4.5%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Dic.</th>';
          $tabla.='<th style="width:7%;" style="background-color: #1c7368; color: #FFFFFF" style="height:12px;">Observaciones</th>';
        $tabla.='</tr>';
        $tabla.='</thead>';
        $tabla.='<tbody>';
        $nro=0;
    ...
    /*------ Lista de Partidas a modificar (2019) -------*/
      ...
      $tabla.='<center>
                <table class="table table-bordered" style="width:80%;" align="center">
                  <tr title="'.$proyecto[0]['aper_id'].'">
                    <td style="width:15%;">
                      <a href="#" data-toggle="modal" data-target="#modal_nuevo_ff" class="btn btn-primary nuevo_ff btn-lg" title="NUEVO REGISTRO PARTIDA" style="width:100%; height:100%;">NUEVO REGISTRO</a>
                    </td>
                ...
                <table class="table table-bordered" id="table" style="width:80%;" align="center">
                  <thead>
                    <tr>
                      ...
                      <th bgcolor="#1c7368"><font color="#ffffff">MONTO DIF.</font></th>
      ...
      foreach($partidas  as $row){
        ...
        $tabla .='
                <tr class="modo1">
                  ...
                  <td align=center><input type="hidden" id="monto'.$nro.'" name="monto_inicial[]" value="'.$row['importe'].'">
                    '.$row['importe'].'
                  </td>
    ...
    /*----------------- Update Temporalidad ---------------------------*/
    public function update_temporalizacion($cite_id,$proy_id,$tp_ins,$ins_id,$insg_id){
      $data['menu']=$this->menu(3); //// genera menu
      $data['proyecto'] = $this->model_proyecto->get_id_proyecto($proy_id);
      ...
      //----------------------------------------------------------------------------------------------------------------------------
       ...
       // echo "Fase id : ".$data['fase'][0]['id'].'-'.$data['gestion'];
        ...
        $data['atras']='';
        $this->load->view('admin/modificacion/operaciones/requerimientos/update_temporalizacion', $data);
    }
