  ...
  public function __construct (){
    ...
    public function mi_poa($proy_id){
      ...
      $tabla.=' <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <th style="width:80%;" bgcolor="#474544"> PROCESO / COMPONENTE</th>
    ...
    public function reporte_evaluar_operaciones($com_id){
      ...
      if(count($data['componente'])!=0){
        ...
        $data['tmes']=$this->model_evaluacion->trimestre();
        $data['operaciones']=$this->lista_operaciones_evaluar($com_id); /// Lista de Operaciones a evaluar en el trimestre
    ...
    function lista_operaciones_evaluar($com_id){
      //$productos=$this->model_producto->list_prod($com_id);
      $tabla='';
