...
class Cevaluacion_pei extends CI_Controller {
  ...
  public function __construct (){
          ...
          <tr style="font-size: 10px;" bgcolor='.$color.'>
            ...
            if(count($evaluado)!=0){
              ...
              if($suma_mevaluado==$row['or_meta']){
                ...
                <td style="width:3%;" align=center><b>EVALUADO</b></td>';
              }
              else{
                $tabla.='
                ...
                <td style="width:15%;" bgcolor="#dfefe4"></td>
                <td style="width:15%;" bgcolor="#dfefe4"></td>
                <td style="width:3%;" align=center><a href="#" data-toggle="modal" data-target="#modal_add_ff" class="btn btn-xs add_ff" title="EVALUAR META OPERACIÓN" name="'.$row['pog_id'].'" class="btn btn-default btn-lg"><img src="'.base_url().'assets/ifinal/eval.jpg" WIDTH="45" HEIGHT="45"/><br>EV. OPE.</a></td>';
              }
            }
            $tabla.='
          </tr>';
      ...
      if($this->input->is_ajax_request() && $this->input->post()){
          ...
          if(count($meta_regional)!=0){
            $result = array(
              ...
              'evaluado' => $this->get_suma_evaluado($pog_id), /// Valor Evaluado 
            );
          }
          else{
            $result = array(
    ...
    public function get_suma_evaluado($pog_id){
      $sum=0;
      ...
      if($this->input->is_ajax_request() && $this->input->post()){
          ...
          if(count($meta_evaluado)!=0){
            $result = array(
              ...
              'total_evaluado' => ($this->get_suma_evaluado($meta_evaluado[0]['pog_id'])+$meta_evaluado[0]['ejec_fis']), /// Valor Evaluado 
            );
          }
          else{
            $result = array(
